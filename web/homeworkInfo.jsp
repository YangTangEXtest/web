...
<head>
    ...
    <%--<script type="text/javascript">--%>
        ...
        <%--&lt;%&ndash;<%String end_t=request.getParameter("end_t");%>&ndash;%&gt;--%>
        <%--&lt;%&ndash;var end_t="<%=begin_t%>";&ndash;%&gt;--%>
        <%--&lt;%&ndash;var first=$(".hwifdt_left").children(":first");&ndash;%&gt;--%>
        <%--&lt;%&ndash;first.next().text(end_t);&ndash;%&gt;--%>
...
<body>
<div id="mubanHomeworkInfo">
<h2 class="hw_title" id="hwtitle"><%=request.getParameter("name")%></h2>
<div class="pb_container">
    <h4 id="hw_info" class="hw_title">&nbsp;&nbsp;作业信息：</h4>
    <div id="hw_info_detail">
        <div class="hwifdt_left">
            <p>起始时间：<%=request.getParameter("begin_t")%></p>
            <%--<p>截止时间：2019-01-18 16:55:18</p>--%>
            <p>截止时间：<%=request.getParameter("end_t")%></p>
        </div>
        <div class="hwifdt_right">
            <p>作业类型：<%=request.getParameter("type")%></p>
            <p>作业比重：<%=request.getParameter("score_weight")%></p>
